...
export default class LoginForm extends React.Component {
  constructor (props) {
    ...
    if (localStorage.getItem('psw')) {
      if (
        ...
        '94a5725a763c52f0199b35ff8638295b9f386b5597b2a471b7ea4021402c6865'
      ) {
  ...
  checkLogin () {
    return new Promise((resolve, reject) => {
      const PASSWORD =
        '94a5725a763c52f0199b35ff8638295b9f386b5597b2a471b7ea4021402c6865'
      this.sha256(this.state.password).then(password => {
        const success =
          this.state.username === 'dallerivemiki' && password === PASSWORD
                ...
                <button
                  ...
                  onClick={e => {
                    ...
                    this.checkLogin().then(success => {
                      success ? this.props.onLoginSuccess() : this.loginFailed()
                    })
                  }}
                >
                  Submit
