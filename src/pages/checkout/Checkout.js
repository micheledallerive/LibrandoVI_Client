...
export default class Checkout extends React.Component{
    ...
    sendOrder(){
        ...
        let prezzoLibri = getTotalPrice(this.props.cart);
        ...
        fetch("https://librandovi.it:3001/order", {
            method: "POST",
            headers: {
    ...
    render(){
        let cartPrice = getTotalPrice(this.props.cart);
        return(
            <Switch>
                        ...
                        <form className="col-lg-8 col-12 mt-lg-0 mt-2" id="checkout-form" noValidate>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group col-lg-4 col-12">
                                    ...
                                    <li className="fas fa-question-circle text-muted ml-2" data-toggle="tooltip" data-placement="top" data-html="false"
                            ...
                            <div className="form-group">
                                ...
                                <li className="fas fa-question-circle text-muted ml-2" data-toggle="tooltip" data-placement="top" data-html="true"
                                    title="
                                        <div class='text-left'>
                            ...
                            <div className="col-12 mt-4 d-flex justify-content-center ">
                                <button className="btn btn-primary col-lg-4 col-12 " onClick={(e)=>{
                                    e.preventDefault();
