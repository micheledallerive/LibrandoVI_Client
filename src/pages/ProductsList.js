      ...
      <>
        <div className='container mt-4 d-flex justify-content-center'>
          <div class='input-group w-75'>
            ...
            <input
              type='text' class='form-control' style={{ borderRadius: '0 .25rem .25rem 0' }} placeholder='Cerca nome, ISBN o autori...' aria-label='ISBN' aria-describedby='basic-addon1' id='filter_input' onChange={(e) => {
          ...
          <div id='books_container' class='mx-4 mt-4'>
            <div className='row w-100'>
              {this.state.books.map((product, index) => (
                <ProductItem key={index} product={product} addToCart={this.props.addToCart} index={index} />
              ))}
            </div>
          </div>
        </InfiniteScroll>
